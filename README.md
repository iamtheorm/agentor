...
All execution is done from within the `coding-rl-environment` directory:
```bash
...
### Step 3: The Negative Run (Verify the Bug)
...
### Step 4: Apply the Reference Patch
...
### Step 5: The Positive Run (Verify the Fix)
